...
/**
 *  The {@code QuickFindUF} class represents a <em>union¡Vfind data type</em>
 ...
 *  <p>
 *  The union¡Vfind data type models connectivity among a set of <em>n</em>
 *  sites, named 0 through <em>n</em>¡V1.
 ...
 *  <em>union</em>¡Xit cannot change during a call
...
public class QuickFindUF {
    ...
    private static int totalAccesses =0; // number of total access of array

    /**
     * Initializes an empty union¡Vfind data structure with {@code n} sites
    ...
    public boolean connected(int p, int q) {
        validate(p);
        validate(q);
        System.out.println("** connected ::determine if connected between node " + p + " and node "+q);
        totalAccesses++;
        return id[p] == id[q];
    }
    ...
    public void union(int p, int q) {
		...
		for (int i = 0; i < id.length; i++) {
			...
			unionAccess++;	
			totalAccesses++;
			System.out.println("**union ::union between node " + p + " and node " + q);
		}
		count--;
		System.out.println("--union ::Total union between node " + p + " and node " + q + " contains " + unionAccess + " accesses!");
    }
    ...
    public static void main(String[] args) {
        ...
        QuickFindUF uf = new QuickFindUF(n);
        while (!StdIn.isEmpty()) {
        	StdOut.println("Head  StdIn.isEmpty()::"+StdIn.isEmpty());
            int p = StdIn.readInt();
            ...
            if (uf.connected(p, q)) continue;
            uf.union(p, q);
            StdOut.println(p + " " + q +";tail StdIn.isEmpty()::"+StdIn.isEmpty());
        }
